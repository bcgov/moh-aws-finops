...
def lambda_handler(event, context):
    ...
    try:
        ...
        for result in response['ResultsByTime']:
            time_period_start = result['TimePeriod']['Start']  # Start date of the time period
            ...
            for group in result['Groups']:
                ...
                report_data.append({
                    ...
                    'start_date': time_period_start,  # Actual start date from the response
                    'end_date': time_period_end       # Actual end date from the response
                })
